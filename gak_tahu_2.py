...
model = Sequential([
    ...
    LSTM(512, return_sequences=True),  # Additional return_sequences=True
...
# Train model
model.fit(question_sequences_padded[:, :-1], encoded_answers, epochs=50, batch_size=64, verbose=1)
...
# Example usage
input_question = "what are you doing now?"
